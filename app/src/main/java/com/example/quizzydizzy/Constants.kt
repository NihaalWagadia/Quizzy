...
object Constants{
    ...
    fun getQuestions():ArrayList<Question>{
        ...
        val question17 = Question(
            17,R.string.question_17,"6","ABC12",(R.string.number_17),false,"Challenge 17", R.drawable.lock_question
        )
        questionList.add(question17)

        val question18 = Question(
            18,R.string.question_18,"10","ABC12",(R.string.number_18),false,"Challenge 18", R.drawable.lock_question
        )
        ...
        val question26 = Question(
            26,R.string.question_26,"70","ABC12",(R.string.number_26),false,"Challenge 26", R.drawable.lock_question
        )
        ...
        val question30 = Question(
            30,R.string.question_30,"971613","ABC12",(R.string.number_30),false,"Challenge 30", R.drawable.lock_question
        )
        questionList.add(question30)

        val question31 = Question(
            31,R.string.question_31,"75","ABC12",(R.string.number_31),false,"Challenge 31", R.drawable.lock_question
        )
        ...
        val question36 = Question(
            36,R.string.question_36,"70","ABC12",(R.string.number_36),false,"Challenge 36", R.drawable.lock_question
        )
        ...
        val question40 = Question(
            40,R.string.question_40,"39","ABC12",(R.string.number_40),false,"Challenge 40", R.drawable.lock_question
        )
